...
<section class="w3-services">
	<div class="container">
			<div class="wthree_head_section">
				<h2 class="w3l_header" style="color:#2556cf;">Special Care</h2>
				...
				<div class="row w3-icon-grid-gap1" style="color:#000;">
					<div class="col-md-12 w3-icon-grid1" >
						...
						<div class="Supp" >
							   	...
							   	<b class="row w3-icon-grid-gap1" style="margin:auto 0;padding-top: 5px;
    padding-bottom: 5px;border: 2px;border-color:#32004b;border-style: solid;margin-bottom:10px;padding-left:10px">Which subject you need Special Care?&nbsp;<span style="color:red">*</span></b>
				...
				<div class="row w3-icon-grid-gap1" style="color:#000;">
					<div class="col-md-12 w3-icon-grid1" >
						...
						<div class="Supp" >
							 	...
							 	<b class="row w3-icon-grid-gap1" style="margin:auto 0;padding-top: 5px;
    padding-bottom: 5px;border: 2px;border-color:#32004b;border-style: solid;margin-bottom:10px;padding-left:10px">Your next mid team &amp; final exam date?&nbsp;<span style="color:red">*</span></b>
				...
				<div class="row w3-icon-grid-gap1">
					<div class="col-md-12 w3-icon-grid1" >
						...
						<div class="Supp">
							...
							margin:auto 0;padding-top: 5px;padding-bottom: 5px;margin-bottom:10px;padding-left:10px">  Do you want to attend our Model Test program to improve your result ?</p>
